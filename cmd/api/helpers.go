    ...
    // check for the different errors 
        ...
        switch {
			...
			case errors.As(err, &unmarshalTypeError):
				...
				return fmt.Errorf("the body contains the incorrect  JSONtype (at character %d)", unmarshalTypeError.Offset)
...
func (appInstance *applicationDependencies) writeJSON(w http.ResponseWriter, status int, data envelope, headers http.Header) error {
