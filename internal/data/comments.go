...
// Get all comments (original version without filtering)
...
// GetAll with filtering (overloaded version)
func (c CommentModel) GetAllFiltered(content string, author string) ([]*Comment, error) {
